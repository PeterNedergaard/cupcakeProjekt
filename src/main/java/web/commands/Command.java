...
public abstract class Command
{
    ...
    private static void initCommands(Database database)
    {
        ...
        commands.put("orderspage", new CommandProtectedPage("orderspage", "employee"));
        commands.put("customerorderspage", new CommandProtectedPage("customerorderspage", "employee"));
